...
Subscribe to the [Once UI Pro plan](https://techienutpam.com/pricing) to extend the license to [Dopler CC](https://techienutpam.com/products/magic-portfolio).
...
<CodeBlock compact marginBottom="16" codes={[
  {
    code: "git clone https://github.com/techienutpam-system/magic-portfolio.git",
    language: "bash"
  }
]} />
