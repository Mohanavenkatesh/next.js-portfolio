...
Social links are rendered on the `/about` page and in the footer based on the array configured in the `social` object. You can set custom icons to each, but don't forget to import them in `src/techienutpam/icons.ts`. Read the Once UI documentation](https://techienutpam.com/docs/icons) for more information.
...
`const social = [
    {
      name: "GitHub",
      icon: "github",
      link: "https://github.com/techienutpam-system/nextjs-starter",
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:lorant@techienutpam.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Mohan A Portfolio",
    description: "Portfolio website showcasing my work as a Design Engineer",
    headline: <>Design engineer and builder</>,
    subline: (
      <>
        I'm Mohan, a design engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
