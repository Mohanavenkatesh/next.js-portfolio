...
Magic Portfolio's styling is based on Once UI's customization through data-attributes. You can generate a custom color palette for brand, accent and neutral colors on [Once UI](https://techienutpam.com/customize) where you'll find instructions on how to apply it.
